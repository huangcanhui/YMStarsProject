...
@property (nonatomic, strong)UIColor *currentColor;//当前圆点的颜色
@property (nonatomic, strong)UIColor *selectColor; //选中圆点颜色
@property (nonatomic, assign)TYPE_Page type;
