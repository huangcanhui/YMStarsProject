...
- (void)initSomeAttribute
{
    ...
    _currentColor = [UIColor darkGrayColor];
...
- (void)createPageControlView
{
    ...
    self.pageControl.currentPageIndicatorTintColor = _selectColor;
    self.pageControl.pageIndicatorTintColor = _currentColor;
...
{
    if ([_delegate respondsToSelector:@selector(tapImageToVCPlayer:)]) {
        [_delegate tapImageToVCPlayer:indexPath.row];
    }
}
